...
class AlertNodeConfigValidatorTest {
    ...
    void validate_success() {
        AlertNodeConfig config = new AlertNodeConfig(NodeType.ALERT, 0, 0, "Title", AlertType.VENTILATION_RECOMMEND, 300);
    ...
    void validate_missingTitle() {
        AlertNodeConfig config = new AlertNodeConfig(NodeType.ALERT, 0, 0,  "   ", AlertType.VENTILATION_RECOMMEND, 300);
