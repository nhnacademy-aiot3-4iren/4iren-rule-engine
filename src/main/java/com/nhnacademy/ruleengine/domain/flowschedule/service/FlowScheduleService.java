...
public interface FlowScheduleService {
    ...
    //특정 플로우의 스케줄 목록 조회
    FlowScheduleListResponse getFlowScheduleList( Long flowId);

    //특정 플로우의 특정 스케줄 조회
    FlowScheduleResponse getFlowScheduleDetail(Long scheduleId);

    //플로우 스케줄 삭제
    void deleteFlowSchedule( Long scheduleId);
}
